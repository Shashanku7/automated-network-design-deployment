        ...
        <header className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          <div>
            ...
            <p className="text-on-surface-variant mt-2">
              Recommended HPE Aruba equipment for your network.
            </p>
          </div>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-surface-container/50 border-b border-outline-variant/10">
                ...
                <th className="px-6 py-4 text-xs font-semibold uppercase tracking-wider text-outline text-center">
                  Qty
                </th>
            ...
            <tfoot>
              <tr className="bg-primary/5 border-t border-primary/20">
                <td
                  colSpan="3"
                  className="px-6 py-4 text-right text-sm font-bold text-on-surface uppercase tracking-wider"
                >
