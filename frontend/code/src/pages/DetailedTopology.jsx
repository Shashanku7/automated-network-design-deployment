        ...
        <header className="mb-8 flex justify-between items-end">
          <div>
            ...
            <p className="text-on-surface-variant mt-2">
              In-depth view of your network architecture.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 bg-surface-container-low px-4 py-2 rounded-lg border border-outline-variant/15">
            <span
              className={`text-sm font-medium ${simpleView ? "text-primary" : "text-on-surface-variant"}`}
            >
              Simple
            </span>
            <button
            ...
            >
              <div
                className={`w-5 h-5 rounded-full bg-white absolute top-0.5 transition-transform ${!simpleView ? "translate-x-6" : "translate-x-0.5"}`}
              />
            </button>
            <span
              className={`text-sm font-medium ${!simpleView ? "text-primary" : "text-on-surface-variant"}`}
        ...
        <div className="bg-surface-container-low rounded-xl border border-outline-variant/15 p-8 min-h-[400px] flex items-center justify-center">
            ...
            (state.diagramUrl ? (
              <div className="w-full">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <a
                    href={state.diagramDownloadUrl || state.diagramUrl}
                    download="network_topology.svg"
          ...
          {activeTab === "ports" && (
            <div className="text-center">
              ...
              <p className="text-xs text-outline mt-4 italic">
                // TODO: [AI TEAM] — render port mapping table here based on
