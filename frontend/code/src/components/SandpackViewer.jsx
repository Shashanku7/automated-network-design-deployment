 ...
 * SandpackViewer.jsx
 *
 * Renders Agent 4's React Flow code live locally using custom SVG icon nodes
 * that match the vanilla.html aesthetic approved by the team.
 *
 * Props:
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full gap-4 bg-surface-dim">
      ...
      <p className="text-on-surface-variant text-sm font-medium">
        Building interactive topology…
      </p>
    </div>
  );
}

// ─── SVG Icons (from vanilla.html — approved design) ─────────────────────────

const ChassisIcon = () => (
  <svg
    viewBox="-50 -30 100 80"
    width="80"
    height="60"
    style={{ overflow: "visible" }}
  >
    <path
      d="M-40 -20 L20 -20 L40 0 L-20 0 Z"
      fill="#c8d1d9"
      stroke="#959da5"
      strokeWidth="1"
    />
    <path
      d="M-40 -20 L-40 20 L-20 40 L40 40 L40 0 L-20 0 Z"
      fill="#e1e4e8"
      stroke="#959da5"
      strokeWidth="1"
    />
    <path
      d="M-40 -20 L-20 0 L-20 40 L-40 20 Z"
      fill="#959da5"
      stroke="#6a737d"
      strokeWidth="1"
    />
...
const SwitchIcon = () => (
  ...
  >
    <path
      d="M-35 -5 L25 -5 L35 5 L-25 5 Z"
      fill="#FF8300"
      stroke="#cc6600"
      strokeWidth="1"
    />
    <path
      d="M-35 -5 L-35 5 L-25 15 L35 15 L35 5 L25 -5 Z"
      fill="#f6f8fa"
      stroke="#d1d5da"
      strokeWidth="1"
    />
    <path
      d="M-35 -5 L-25 5 L-25 15 L-35 5 Z"
      fill="#d1d5da"
      stroke="#959da5"
      strokeWidth="1"
    />
...
const NACIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M 0 -15 L 10 -10 L 10 2 C 10 8 0 15 0 15 C 0 15 -10 8 -10 2 L -10 -10 Z"
      fill="#1a1f36"
    />
...
const IoTIcon = () => (
  ...
  >
    ...
    <path
      d="M -12 -6 L -16 -6 M -12 0 L -16 0 M -12 6 L -16 6 M 12 -6 L 16 -6 M 12 0 L 16 0 M 12 6 L 16 6 M -6 -12 L -6 -16 M 0 -12 L 0 -16 M 6 -12 L 6 -16 M -6 12 L -6 16 M 0 12 L 0 16 M 6 12 L 6 16"
      stroke="#00A3AD"
      strokeWidth="2"
    />
  </svg>
...
const StorageIcon = () => (
  ...
  >
    <path
      d="M -20 -10 C -20 -15 20 -15 20 -10 L 20 10 C 20 15 -20 15 -20 10 Z"
      fill="#e1e4e8"
      stroke="#d0d7de"
      strokeWidth="2"
    />
    <path
      d="M -20 -10 C -20 -5 20 -5 20 -10"
      fill="none"
      stroke="#d0d7de"
      strokeWidth="2"
    />
    <path
      d="M -20 0 C -20 5 20 5 20 0"
      fill="none"
      stroke="#d0d7de"
      strokeWidth="2"
    />
...
const LoadBalancerIcon = () => (
  ...
  >
    ...
    />
    <path
      d="M -15 -15 L 0 0 L 15 -15 M 0 0 L 0 15 M -5 -10 L 5 -10"
      stroke="#FF8300"
      strokeWidth="2"
      fill="none"
    />
...
const ServerIcon = () => (
  ...
  >
    <path
      d="M-15 -30 L15 -30 L25 -20 L-5 -20 Z"
      fill="#00A3AD"
      stroke="#007e85"
      strokeWidth="1"
    />
    <path
      d="M-15 -30 L-15 10 L-5 20 L25 20 L25 -20 L15 -30 Z"
      fill="#f6f8fa"
      stroke="#d1d5da"
      strokeWidth="1"
    />
    <path
      d="M-15 -30 L-5 -20 L-5 20 L-15 10 Z"
      fill="#d1d5da"
      stroke="#959da5"
      strokeWidth="1"
    />
...
const GatewayIcon = () => (
  ...
  >
    <path
      d="M-25 -15 L15 -15 L25 -5 L-15 -5 Z"
      fill="#f85149"
      stroke="#da3633"
      strokeWidth="1"
    />
    <path
      d="M-25 -15 L-25 10 L-15 20 L25 20 L25 -5 L15 -15 Z"
      fill="#ffffff"
      stroke="#d1d5da"
      strokeWidth="1"
    />
    <path
      d="M-25 -15 L-15 -5 L-15 20 L-25 10 Z"
      fill="#d1d5da"
      stroke="#959da5"
      strokeWidth="1"
    />
...
const LaptopIcon = () => (
  ...
  >
    ...
    <path
      d="M-24 10 L24 10 L28 15 L-28 15 Z"
      fill="#e1e4e8"
      stroke="#959da5"
      strokeWidth="1"
    />
...
const PhoneIcon = () => (
  ...
  >
    ...
    <path
      d="M10 -15 L-15 -15 A 3 3 0 0 0 -18 -12 L-18 10 A 3 3 0 0 0 -15 13 L-12 13 L-12 -12 L10 -12 Z"
      fill="#24292e"
    />
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginTop: "6px", lineHeight: 1.4 }}>
        {lines[0] && (
          <div
            style={{ fontWeight: "bold", fontSize: "12px", color: "#1a1a1a" }}
          >
            {lines[0]}
          </div>
        )}
...
// Register the custom node type — must be defined OUTSIDE the component to avoid re-registration
const nodeTypes = { custom: CustomNode };

// ─── JSON Extraction from Generated React Code ────────────────────────────────
function extractJSONArrays(reactCode) {
  try {
    // Match the full nodes array — stops at the closing ]; of the array
    const nodesMatch = reactCode.match(
      /const\s+nodes\s*=\s*(\[[\s\S]*?\])\s*;/,
    );
    const edgesMatch = reactCode.match(
      /const\s+edges\s*=\s*(\[[\s\S]*?\])\s*;/,
    );
    ...
    console.error(
      "[SandpackViewer] Failed to parse nodes and edges from reactCode:",
      err,
    );
    return null;
  }
...
export default function SandpackViewer({ reactCode, onError }) {
  const data = useMemo(
    () => (reactCode ? extractJSONArrays(reactCode) : null),
    [reactCode],
  );
    ...
    return (
      <div className="flex flex-col items-center justify-center h-full gap-4 bg-surface-dim text-error p-4 text-center">
        ...
        <p className="text-xs text-outline">
          Please check console logs or request a change.
        </p>
      </div>
    );
  }
