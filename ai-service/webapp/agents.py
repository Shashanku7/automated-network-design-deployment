...
agent4 = FunctionAgent(
    ...
    system_prompt=(
        ...
        "- VSX Inter-Switch Link (ISL):\n"
        "    If Core/Distribution switches are deployed as a VSX pair, you MUST create a direct edge connecting the two switches in the pair.\n"
        ...
        "  - Gateways and Firewalls (iconType: Gateway): representing SD-WAN edges or firewalls. If present in the design or BOM, place them at y=0, to the left of the Core switches (e.g., at x=-300).\n"
        "  - Core switches (iconType: Chassis): y=0, centered horizontally. If a VSX pair is used, place them at y=0, with VSX-1 at x=-100 and VSX-2 at x=100.\n"
        "  - Distribution switches (iconType: Switch): y=160, one pair per building, spaced 320px apart.\n"
        "  - NACs (iconType: NAC): representing ClearPass / authentication servers. If present in the design or BOM, place them at y=80, connected directly to the Core switches.\n"
        "  - WLCs (iconType: WLC): if present, place at y=160, near the core or distribution layer.\n"
        ...
        "  Line 2: Count for end devices, IP address for infrastructure (e.g., '(23)' or '10.10.99.1'). If the switch is a VSX Core switch, specify its role explicitly as 'Core VSX-1' or 'Core VSX-2' on this line.\n"
        "  Line 3: Role and VLAN (e.g., 'Core / VLAN 10' or 'Core VSX-1 / VLAN 99')\n\n"
