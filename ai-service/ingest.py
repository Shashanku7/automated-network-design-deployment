...
QWEN_EMBEDDING_MAX_TOKENS = 1024
...
def build_sparse_vectors(texts: list[str], top_k: int = SPARSE_TOP_K) -> list[models.SparseVector]:
    """
    Build sparse vectors from Qwen embedding model.
    Converts dense embeddings to sparse format by keeping top-k values per text.
    """
