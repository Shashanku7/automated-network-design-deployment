...
QWEN_CODE_MODEL = os.getenv("QWEN_CODE_MODEL", "qwen3-coder:480b-cloud")
FALLBACK_OLLAMA_BASE_URL = os.getenv("FALLBACK_OLLAMA_BASE_URL", "https://api.ollama.com")
FALLBACK_OLLAMA_API_KEY = os.getenv("FALLBACK_OLLAMA_API_KEY")
...
POSTGRES_URI = os.getenv("POSTGRES_URI", "postgresql+asyncpg://postgres:root@localhost:5433/network_design")
